...
const initArticles = (supabase, projectId) => {
    ...
    const getArticles = async () => {
        try {
            ...
            (0, api_client_1.handleError)(error, "Failed to fetch articles");
    ...
    const getArticleBySlug = async (slug) => {
        try {
            ...
            (0, api_client_1.handleError)(error, "Failed to fetch article");
            return { data: null, error };
        }
    };
    ...
    const getArticlesByCategory = async (category) => {
        try {
            ...
            (0, api_client_1.handleError)(error, "Failed to fetch articles by category");
            return { data: null, error };
        }
    };
    ...
    const getAllArticles = async () => {
        try {
            ...
            (0, api_client_1.handleError)(error, "Failed to fetch all articles");
            return { data: null, error };
        }
    };
    ...
    const createArticle = async (article) => {
        try {
            ...
            (0, api_client_1.handleError)(error, "Failed to create article");
            return { data: null, error };
        }
    };
    ...
    const updateArticle = async (id, updates) => {
        try {
            ...
            (0, api_client_1.handleError)(error, "Failed to update article");
            return { data: null, error };
        }
    };
    ...
    const updateArticleStatus = async (id, status) => {
        try {
            ...
            (0, api_client_1.handleError)(error, "Failed to update article status");
            return { data: null, error };
        }
    };
    ...
    const deleteArticle = async (id) => {
        try {
            ...
            (0, api_client_1.handleError)(error, "Failed to delete article");
            return { data: null, error };
        }
    };
    return {
