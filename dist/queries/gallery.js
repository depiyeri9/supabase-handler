...
const initGallery = (supabase, projectId) => {
    ...
    const getGalleryItems = async () => {
        try {
            ...
            (0, api_client_1.handleError)(error, "Failed to fetch gallery items");
    ...
    const getFeaturedGalleryItems = async () => {
        try {
            ...
            (0, api_client_1.handleError)(error, "Failed to fetch featured gallery items");
            return { data: null, error };
        }
    };
    ...
    const getGalleryItemsByCategory = async (category) => {
        try {
            ...
            (0, api_client_1.handleError)(error, "Failed to fetch gallery items by category");
            return { data: null, error };
        }
    };
    ...
    const createGalleryItem = async (item) => {
        try {
            ...
            (0, api_client_1.handleError)(error, "Failed to create gallery item");
            return { data: null, error };
        }
    };
    ...
    const updateGalleryItem = async (id, updates) => {
        try {
            ...
            (0, api_client_1.handleError)(error, "Failed to update gallery item");
            return { data: null, error };
        }
    };
    ...
    const deleteGalleryItem = async (id) => {
        try {
            ...
            (0, api_client_1.handleError)(error, "Failed to delete gallery item");
            return { data: null, error };
        }
    };
    return {
